	...
	render: function render() {
		return (
			React.createElement("div", { className: "well" },
				React.createElement("h1", { className: "vert-offset-top-0" }, "To do:"),
	...
	render: function render() {
		...
		return (
			React.createElement("li", { className: classes },
				this.props.task,
				React.createElement("div", { className: "pull-right", role: "group" },
					React.createElement("button", { type: "button", className: "btn btn-xs btn-success img-circle", onClick: this.toggleComplete }, "\u2713"), " ", React.createElement("button", { type: "button", className: "btn btn-xs btn-danger img-circle", onClick: this.removeNode }, "\uFF38"))));
...
var TodoForm = React.createClass({ displayName: "TodoForm",
	...
	render: function render() {
		return (
			React.createElement("div", { className: "commentForm vert-offset-top-2" },
				React.createElement("hr", null),
				React.createElement("div", { className: "clearfix" },
					React.createElement("form", { className: "todoForm form-horizontal", onSubmit: this.doSubmit },
						React.createElement("div", { className: "form-group" },
							React.createElement("label", { htmlFor: "task", className: "col-md-2 control-label" }, "Task"),
						...
						React.createElement("div", { className: "row" },
							React.createElement("div", { className: "col-md-10 col-md-offset-2 text-right" },
